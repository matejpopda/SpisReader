...
def main():
    ...
    total_charge = plotters.glob_properties(
        result, "improved__total_charge_density_at_t_=_*"
    )
    ...
    total_charge = plotters.glob_properties(
        result, "improved_ions1_charge_density_at_t_=*"
    )
    log.info("started plotting gif of size " + str(len(total_charge)))
    ...
    total_charge = plotters.glob_properties(
        result, "improved_net_current__on_regular_surf_at_t_=*"
    )
    log.info("started plotting gif of size " + str(len(total_charge)))
